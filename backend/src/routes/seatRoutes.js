...
import { createSeat, getSeatsByHallAndMovie, updateSeat, deleteSeat, getSeatsByHallAndSchedule } from '../controllers/seatController.js';
...
router.get('/seats/:id_sala/:id_pelicula', getSeatsByHallAndMovie); // Obtener todos los asientos de una sala 
