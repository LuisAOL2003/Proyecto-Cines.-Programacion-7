  ...
  <nav class="navbar container" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
      ...
      <a class="navbar-item" href="/">
        ...
        <strong class="is-size-4 has-text-white">Cinecity: Tu cine, Tu Película (Cliente)</strong>
      </a>
    ...
    <!-- Menú de navegación -->
    <div id="navbarClientMenu" class="navbar-menu" :class="{'is-active': isMenuActive}">
      <div class="navbar-start">
        <router-link to="/user" class="navbar-item">Home</router-link>
      </div>
