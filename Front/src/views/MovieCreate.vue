<template>
  <div>
    ...
    <Footer /> <!-- Componente Footer movido aquí -->
  </div>
</template>

<script>
import SearchModal from '../components/SearchModal.vue';
import Footer from '../components/partials/Footer.vue'; // Importar el componente Footer

export default {
  name: 'MovieCreate',
  components: {
    SearchModal,
    Footer // Registrar el componente Footer
  },
  data() {
    return {
      isModalActive: true,
